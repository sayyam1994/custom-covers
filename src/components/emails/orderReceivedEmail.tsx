...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === 'development'
      ? 'http://localhost:3000'
      : 'https://custom-covers.vercel.app'
  return (
    <Html>
      <Head />
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              ...
              your package has been shipped. Delivery usually takes 3 to 7 days.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If you have any questions, please dont hesitate to contact us with
              your order number.
            </Text>
          </Section>
          <Hr style={global.hr} />
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                ...
                this email, it will be ignored.)
              </Text>
            </Row>
            <Row>
              <Text style={footer.text}>
                @ CustomCovers, Inc. All rights reserved
              </Text>
            </Row>
          </Section>
        </Container>

    ...
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 lg:gap-x-0 lg:pt-24 lg:pb-52 sm:pb-32 xl:gap-x-8 xl:pt-32">
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:m-x-0 lg:mt-20 h-fit">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  The case feels durable and I even got compliments on design.
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  phone case. This one, besides a barely noticeable scratch on
                  the corner,{' '}
                  <span className="p-0.5 bg-slate-800 text-white">
                    looks brand new after 6 months
                  </span>
                  , and I dig it.
                </p>
              </div>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
                ...
                <span className="text-white bg-purple-600">your own case</span>{' '}
                now
              </h2>
            </div>
          </div>
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            ...
            <li className="w-fit">
              <Check className="h-5 w-5 text-purple-600 inline mr-1.5" />5 years
              print warranty
            </li>
          </ul>
          ...
          <div className="flex justify-center">
            ...
            >
              Create your case now <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </div>
        </MaxWidthWrapper>
      </section>
